    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
        <motion.div
          ...
          animate={{ opacity: [0, 1], scale: [0.8, 1], rotate: 360 }}
        ...
        <div className="space-y-3">
          {currentQ.options.map((opt, idx) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-purple-800 rounded-xl hover:from-purple-500 hover:to-purple-600 transition text-lg font-medium shadow-md"
            >
              {opt}
            </motion.button>
          ))}
