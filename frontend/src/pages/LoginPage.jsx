...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-950 via-indigo-950 to-pink-950 px-4 py-8">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            Sign in to discover your spirit animal
          </motion.p>
        </div>
